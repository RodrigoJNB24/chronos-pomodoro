...
export function Settings() {
  ...
  function handleSaveSettings(e: React.SubmitEvent<HTMLFormElement>) {
    ...
    if (isNaN(workTime) || isNaN(shortBreakTime) || isNaN(longBreakTime)) {
      formErrors.push('Por favor use apenas numeros para todos os campos');
    }

    if (workTime < 1 || workTime > 99) {
      formErrors.push('Por favor digite valores entre 1 e 99 para foco');
    }

    if (shortBreakTime < 1 || shortBreakTime > 30) {
      formErrors.push(
        'Por favor digite valores entre 1 e 30 para descanso curto',
      );
    }

    if (longBreakTime < 1 || longBreakTime > 60) {
      formErrors.push(
        'Por favor digite valores entre 1 e 60 para descanso longo',
      );
    }
